...
export const STORAGE_KEYS = [
  ...
  { key: 'spothitch_spot_cache_purged', category: DataCategory.CACHE, description: 'One-shot flag: stale spot cache purged after Hitchwiki removal' },
  ...
  { key: 'spothitch_spot_index', category: DataCategory.CACHE, description: 'Spot index with country counts for offline panel' },
  { key: 'spothitch_offline_dismissed', category: DataCategory.SETTINGS, description: 'Offline download banner dismissed' },
  ...
  { key: 'spothitch_url_log', category: DataCategory.CACHE, description: 'Temporary URL debug log for share target diagnosis' },
