...
export const guideSectionsData = {
  ...
  OM: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Eines der sichersten Länder der Welt. Kriminalitätsrate quasi null.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '9999' }] }] },
  ...
  SN: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Eines der stabilsten Länder Westafrikas. Meide die Casamance-Grenzgebiete.' }, { type: 'kv', items: [{ k: 'Polizei', v: '17' }, { k: 'Feuerwehr', v: '18' }] }] },
  ...
  KE: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Generell sicher. Meide Nordosten (somalische Grenze) und Nairobi-Slums.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '999 / 112' }] }] },
  ...
  ET: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Hängt von der Region ab. Touristengebiete (Lalibela, Gondar) sicher. Prüfe aktuelle Lage.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '911' }] }] },
  ...
  MM: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Hängt von der politischen Lage ab. Prüfe Reisehinweise.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '199' }] }] },
  ...
  PH: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Generell sicher. Meide West-Mindanao. Taifune Jun-Nov.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '911' }] }] },
  ...
  LK: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Sicheres Land. Bürgerkrieg endete 2009. Kriminalität gegen Touristen sehr selten.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '119 / 110' }] }] },
  ...
  MN: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Sicher auf dem Land. Natur ist die wahre Gefahr: extreme Kälte, Entfernungen.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '102 / 103' }] }] },
  ...
  CU: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Eines der sichersten Länder Amerikas.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '106 / 104' }] }] },
  ...
  GT: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Hohe Kriminalität in Städten. Highlands und Touristengebiete sicherer. Nicht nachts reisen.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '110 / 120' }] }] },
  ...
  CR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Sicherstes Land Zentralamerikas.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '911' }] }] },
  ...
  EG: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'In Hauptgebieten generell sicher. Meide nördlichen Sinai und libysche Grenze.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '122 / 123' }] }] },
  ...
  TZ: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Sicher für Reisende. Meide Dar es Salaam nachts.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '112 / 114' }] }] },
  ...
  TJ: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Sicher. Pamir-Straßen gefährlich (Abgründe, Höhe).' }, { type: 'kv', items: [{ k: 'Notfälle', v: '112' }] }] },
  ...
  KR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Eines der sichersten Länder der Welt.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '112 / 119' }] }] },
  ...
  PK: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Norden (Hunza, Gilgit-Baltistan) sehr sicher. Meide Belutschistan.' }, { type: 'kv', items: [{ k: 'Rettung', v: '1122' }] }] },
  ...
  MY: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Sicher. Meide Ost-Sabah.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '999' }] }] },
  ...
  TW: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Eines der sichersten Länder Asiens.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '110 / 119' }] }] },
  ...
  LB: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Sicherheit schwankt. Prüfe aktuelle Lage.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '112' }] }] },
  ...
  PA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Relativ sicher. Meide Colón und Darién.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '911' }] }] },
  ...
  GH: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Eines der stabilsten Länder Afrikas.' }, { type: 'kv', items: [{ k: 'Polizei', v: '191' }] }] },
  ...
  UG: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Generell sicher. Meide kongolesische Grenze. Gorillas in sicherem Gebiet.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '999 / 112' }] }] },
  ...
  RW: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Eines der sichersten Länder Afrikas.' }, { type: 'kv', items: [{ k: 'Notfälle', v: '112' }] }] },
  ...
  MW: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [{ type: 'text', text: 'Sehr sicher. Touristenkriminalität sehr selten.' }, { type: 'kv', items: [{ k: 'Polizei', v: '997' }, { k: 'Krankenwagen', v: '998' }] }] },
