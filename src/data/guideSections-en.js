...
export const guideSectionsData = {
  ...
  HR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Generally safe. The coast is entirely demined. Coastal roads can be dangerous (mountain on one side, cliff on the other). Be cautious as a pedestrian.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  SI: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Very safe. Slovenia is one of the safest countries in Europe. No landmines. No specific concerns for hitchhikers.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  AL: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Generally safe. Violent crime against tourists is virtually non-existent. Drivers make detours to help. Watch out for road conditions (poor roads, unpredictable driving) and low traffic in northern mountains.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  BA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Generally safe for hitchhikers. Described as "safer than Belgium" by Dutch sources. Hospitality is remarkably warm towards foreigners.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  ME: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Safe country. Unlike its neighbours, Montenegro avoided the 90s conflicts, so no landmines. Narrow coastal roads and tunnels are the main physical risk for pedestrians.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  MK: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Very safe. Locals are not only welcoming but often protective towards visitors.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  PL: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Safe country, among the 25 safest in the world. Police are friendly towards hitchhikers who follow the rules.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
      { type: 'warn', text: '⚠️ In northern Poland in summer, sex workers stand by the roads. Lone women may be mistaken. Tip: don\'t wear revealing clothes, hold your backpack in front of you.' },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  CZ: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Safe. Crime consists mainly of pickpocketing in tourist areas. German police sometimes check documents at the Czech-German border.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  SK: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Safe country. Best combination: travel as a mixed pair (man and woman).' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  HU: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Safe and politically stable. Tap water is drinkable everywhere.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  RO: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Generally safe. Romanian drivers are notoriously aggressive behind the wheel (dangerous overtaking, high speed). Buckle up. Stray dogs are common in rural areas.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  BG: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Generally safe but with specific warnings. Aggressive driving is common. Police may check passports and potentially seek bribes near borders. Western passport holders are rarely bothered.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
      { type: 'tip', text: '💡 In Bulgaria, head gestures for "yes" and "no" are reversed compared to the West (nodding = no, shaking = yes). Many Bulgarians have adapted to Western conventions, but confusion is frequent.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  LT: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'No major concerns. The country is very safe. Travelling in pairs significantly reduces risks.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  LV: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Safe and calm. The country is very safe. Road conditions deteriorate in winter and early spring.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  EE: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Very safe. Crimes related to hitchhiking are extremely rare. Watch out for intoxicated drivers: avoid cars where occupants seem drunk.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  TR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'In 99% of cases, hitchhiking goes well. In eastern Turkey, police may be suspicious of foreigners (PKK tensions). They are serious but offer tea and respect.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
      { type: 'warn', text: '⚠️ Avoid border regions with Syria and Iraq. The Foreign Ministry advises against these areas.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  GE: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Generally safe. The main risk is aggressive driving (high speed, traffic rules ignored). Mountain roads can be dangerous. Refusing alcohol (especially chacha, the national brandy) can offend in rural areas.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  AM: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Armenia is one of the safest countries in the world. The sense of security is very high. Police are benevolent and helpful.' },
      { type: 'kv', items: [{ k: 'Emergency', v: '112' }] },
      { type: 'warn', text: '⚠️ Avoid border areas with Azerbaijan (mines, military tensions). The Nojemberyan-Idjevan stretch is specifically not recommended.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  UA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Safety depends entirely on the zone. In peacetime, Ukraine is a safe country with welcoming people. Check foreign ministry advisories before travelling.' },
      { type: 'kv', items: [
        { k: 'Emergency', v: '112' },
        { k: 'Police', v: '102' },
        { k: 'Ambulance', v: '103' },
  ...
  XK: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Kosovo is safe for travellers. Crime against tourists is virtually non-existent. International presence (KFOR, EULEX) contributes to security.' },
  ...
  MA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Morocco is generally safe. Violent crime is rare. Tourist scams (fake guides, inflated prices) are the main risk. Moroccans are mostly welcoming and protective towards travellers.' },
      { type: 'kv', items: [
        { k: 'Police', v: '19' },
        { k: 'Gendarmerie (outside cities)', v: '177' },
        { k: 'Fire brigade / Emergency medical', v: '15' },
      ]},
      { type: 'warn', text: '⚠️ Avoid border areas with Algeria (closed) and remote Western Sahara regions without a local guide.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  US: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'The real risk is overestimated by media culture. Hitchhiking remains a safe mode of transport when basic precautions are followed. However, wariness is mutual: both drivers and hitchhikers are on their guard.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '911' }] },
      { type: 'warn', text: '⚠️ Never accept a ride if the driver seems under the influence of drugs or alcohol. Do not hitchhike at night. Some isolated rural areas have no phone signal.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  NZ: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'New Zealand is one of the safest countries in the world. Crime against tourists is very rare. Solo travellers, including women, report very positive experiences.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '111' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  AU: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Australia is generally safe but distances and heat are the real dangers. In the Outback, temperatures exceed 45°C and phone signal is non-existent for hundreds of kilometres.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '000' }, { k: 'From a mobile', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  AR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Argentina is generally safe for hitchhiking outside Buenos Aires. Patagonia is very safe. The northwest is welcoming. Avoid the outskirts of Buenos Aires and Rosario.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '911' }, { k: 'Police', v: '101' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  CL: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Chile is the safest country in South America. Violent crime is rare outside certain neighbourhoods of Santiago. Chileans are welcoming and Chilean Patagonia is very safe.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '131' }, { k: 'Carabineros (police)', v: '133' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  CO: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Colombia has changed enormously since the 2000s. Tourist areas and main roads are safe. Avoid remote non-tourist areas and border zones (Venezuela, rural Ecuador).' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '123' }, { k: 'Police', v: '112' }] },
      { type: 'warn', text: '⚠️ Do not travel at night on secondary roads. Check locally about areas to avoid. Fake checkpoints (falsos retenes) are very rare but exist.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  TH: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Thailand is a safe country for travellers. Violent crime against tourists is very rare. Scams (tuk-tuk, jewellery, metered taxis) are the main risk.' },
      { type: 'kv', items: [
        { k: 'Emergencies / Tourist Police', v: '1155' },
        { k: 'Ambulance', v: '1669' },
        { k: 'Police', v: '191' },
      ]},
    ]},
  ...
  IN: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'India is generally safe but can be chaotic. Truck drivers are generally reliable. Never get into a vehicle if the occupants seem intoxicated. Indian traffic is the main danger (unpredictable driving).' },
      { type: 'kv', items: [
        { k: 'Emergencies', v: '112' },
        { k: 'Police', v: '100' },
        { k: 'Ambulance', v: '108' },
  ...
  JP: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Japan is one of the safest countries in the world. You can leave your bag unattended. Crime against foreigners is virtually non-existent. The only risk is getting lost.' },
      { type: 'kv', items: [{ k: 'Emergencies / Fire', v: '119' }, { k: 'Police', v: '110' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  ZA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'South Africa has a high crime rate. Car-jacking and theft are real risks. However, rural and tourist areas are much safer. NEVER hitchhike at night.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '10111' }, { k: 'Ambulance', v: '10177' }] },
      { type: 'warn', text: '⚠️ Do not hitchhike alone in urban areas. Prioritise rural areas and the Garden Route. Check locally about areas to avoid.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  IR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Iran is a very safe country for travellers. Crime is low. Iranians are protective of foreigners. The main risk is eating too much (every driver insists on treating you). Avoid border areas (Sistan-Baluchestan, borders with Iraq and Afghanistan).' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '115' }, { k: 'Police', v: '110' }] },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  TN: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Tunisia is generally safe for travellers. Avoid border areas with Libya and Algeria (Kasserine, Jendouba). Tourist scams exist in the medinas.' },
      { type: 'kv', items: [{ k: 'Police', v: '197' }, { k: 'Emergency medical', v: '190' }, { k: 'Emergencies', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  MX: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Safety varies enormously by region. The south (Oaxaca, Chiapas, Yucatan) and centre (Guanajuato, Puebla) are the safest. Absolutely avoid the northwest (Sinaloa), Tamaulipas and problematic border areas.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '911' }, { k: 'Tourist police', v: '078' }] },
      { type: 'warn', text: '⚠️ NEVER travel at night on northern Mexico roads. Check locally and with other travellers (Facebook groups) about areas to avoid.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  BR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Safety depends on the region. The south and rural areas are safe. Avoid favelas and outskirts of big cities (Sao Paulo, Rio). Do not hitchhike at night.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '190 (police) / 192 (emergency medical)' }] },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  PE: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Peru is generally safe outside Lima and certain border areas (VRAEM). The Andes and the touristy south (Cusco, Arequipa) are safe.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '105 (police) / 116 (fire)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  BO: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Bolivia is safe for travellers. The main risk is altitude sickness (La Paz is at 3,640m, the Salar at 3,650m). Mountain roads are dangerous (bends, cliffs, no guardrails).' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '110 (police) / 118 (ambulance)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  EC: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Ecuador is moderately safe. Tourist areas (Quito centro, Cuenca, Banos) are safe. Avoid the Colombian border (Esmeraldas, Sucumbios) and southern Guayaquil neighbourhoods.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '911' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  UY: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Uruguay is the safest country in South America. Crime rate is low outside certain neighbourhoods of Montevideo.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '911' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  VN: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Vietnam is a very safe country. Violent crime is virtually non-existent. Pickpockets and scams (taxis, tours) are the main risks. Traffic is chaotic but serious accidents involving pedestrians are rare.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '113 (police) / 115 (ambulance)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  LA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Laos is a very safe country. Crime is very low. The main risk is UXO (unexploded ordnance from the Vietnam War) in rural areas. NEVER stray from well-trodden paths in the countryside.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '1195 (ambulance) / 1191 (police)' }] },
      { type: 'warn', text: '⚠️ Laos is the most bombed country in history. 30% of the bombs did not explode. NEVER venture off-path in rural areas.' },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  KH: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Cambodia is safe for travellers. Avoid border areas with Thailand (Preah Vihear) and anti-personnel mines in rural areas (do not leave the paths).' },
      { type: 'kv', items: [{ k: 'Emergencies / Police', v: '117' }, { k: 'Ambulance', v: '119' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  NP: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Nepal is a safe and peaceful country. Crime against tourists is very rare. Mountain roads are the main danger (cliffs, unpaved roads, daring drivers).' },
      { type: 'kv', items: [{ k: 'Tourist police', v: '1144' }, { k: 'Emergencies', v: '102 (police) / 103 (ambulance)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  KZ: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Kazakhstan is safe. Police may do checks (have your passport). Roads are long and straight, heat and wind are the real enemies.' },
  ...
  KG: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Kyrgyzstan is safe. Crime is low. Mountain roads are the main danger (passes above 3,000m, no guardrails).' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '112' }, { k: 'Police', v: '102' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  UZ: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Uzbekistan is very safe. The country is authoritarian and crime is very low. Police checks are frequent (have your passport and registration).' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '112' }, { k: 'Police', v: '102' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  JO: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Jordan is very safe. The country is stable and crime is low. Police are present and friendly. Avoid the Syrian border (northeast).' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '911' }, { k: 'Tourist police', v: '1-800-22-228' }] },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  SN: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Senegal is one of the most stable and safe countries in West Africa. Crime against tourists is low. Avoid the Casamance border areas (south).' },
      { type: 'kv', items: [{ k: 'Police', v: '17' }, { k: 'Fire / Emergency medical', v: '18' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  NAM: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Namibia is safe in rural areas. Windhoek has neighbourhoods to avoid at night. The main danger is nature: heat, distances, wild animals (elephants on roads in the north).' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '10111' }, { k: 'Ambulance', v: '211111' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  KE: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Kenya is generally safe outside certain areas. Avoid the northeast (Somali border), Nairobi slums and the northern coast (Lamu) without recent information.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '999 / 112' }, { k: 'Police', v: '999' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  ET: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Safety depends on the region. Tourist areas (Lalibela, Gondar, Omo Valley) are safe. Avoid conflict zones (Tigray, parts of Oromia/Amhara). Check the current situation.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '911 / 991' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  MM: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Safety depends entirely on the current political situation. Classic tourist areas (Bagan, Mandalay, Inle) were very safe before 2021. Check your foreign ministry\'s advisories.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '199' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  IDN: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Indonesia is generally safe. Indonesians are extremely welcoming. Avoid Papua province (conflicts) and certain areas of Sulawesi.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '112' }, { k: 'Police', v: '110' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  LK: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Sri Lanka is a safe country. The civil war ended in 2009. Crime against tourists is very rare. Sri Lankans are protective of visitors.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '119 (police) / 110 (ambulance)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  MN: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Mongolia is safe in rural areas. Ulaanbaatar has problems with alcoholism and pickpockets. Nature is the real danger: extreme cold, distances, no signal.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '102 (police) / 103 (ambulance)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  GT: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Guatemala has a high crime rate in cities (Guatemala City, drug trafficking areas). The Highlands and tourist areas (Antigua, Atitlan) are much safer. Do not travel at night.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '110 (fire) / 120 (police)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  CR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Costa Rica is the safest country in Central America. Tourist crime is low. Petty theft is the main risk (especially on beaches).' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '911' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  EG: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Egypt is generally safe for tourists in main areas (Cairo, Luxor, Aswan, coast). Avoid northern Sinai (except Sharm el-Sheikh and Dahab) and the Libyan border.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '122 (police) / 123 (ambulance)' }] },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  TZ: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Tanzania is safe for travellers. Tourist crime is low. Avoid Dar es Salaam at night and certain neighbourhoods.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '112 / 114' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  KR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'South Korea is one of the safest countries in the world. Crime is virtually non-existent. You can leave your belongings anywhere.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '112 (police) / 119 (fire/ambulance)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  PK: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'The north (Hunza, Gilgit-Baltistan, Swat) is very safe. Avoid Balochistan, southern KPK and tribal areas.' },
  ...
  TW: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'One of the safest countries in Asia. Crime is virtually non-existent.' },
      { type: 'kv', items: [{ k: 'Police', v: '110' }, { k: 'Emergencies', v: '119' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  LB: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Safety fluctuates. Tourist areas (Beirut, Byblos, Baalbek) generally safe. Check the current situation.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '112' }, { k: 'Red Cross', v: '140' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  PA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Relatively safe. Avoid Colon and the Darien.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '911' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  GH: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'One of the most stable countries in Africa. Tourist crime is low.' },
  ...
  UG: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Generally safe. Avoid the Congolese border and Karamoja. Bwindi gorillas are in a safe area.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '999 / 112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  RW: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'One of the safest countries in Africa. Very low crime, clean and organised.' },
      { type: 'kv', items: [{ k: 'Emergencies', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  MW: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Very safe. Tourist crime is very rare.' },
