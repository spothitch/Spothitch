...
export const guideSectionsData = {
  ...
  GR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Grecia es uno de los países más seguros de Europa para los viajeros. Los incidentes negativos relacionados con el autostop son extremadamente raros. Los conductores griegos ofrecen espontáneamente comida, bebidas y alojamiento.' },
      { type: 'sub', title: 'Números de emergencia' },
      { type: 'kv', items: [
        { k: 'Emergencias', v: '112' },
        { k: 'Policía', v: '100' },
  ...
  NO: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Noruega es uno de los países más seguros del mundo. El principal riesgo es el clima y el aislamiento (largas distancias entre ciudades, frío, lluvia, nieve), no la gente.' },
      { type: 'sub', title: 'Números de emergencia' },
      { type: 'kv', items: [
        { k: 'Emergencias', v: '112' },
        { k: 'Policía', v: '02800' },
  ...
  SE: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'País muy seguro. Ningún incidente reportado por autostopistas. El principal riesgo son las largas distancias en el norte con pocos coches.' },
      { type: 'sub', title: 'Números de emergencia' },
  ...
  IS: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Islandia está considerada el país más seguro del mundo para viajeras solas. La delincuencia es casi inexistente. El verdadero peligro es el clima: cambia en pocos minutos, y quedarse tirado lejos de una ciudad con tiempo ártico es el riesgo principal.' },
      { type: 'sub', title: 'Números de emergencia' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  FI: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Finlandia es uno de los países más seguros del mundo. Ningún incidente reportado por autostopistas. Los lapones son descritos como "de las personas más simpáticas y serviciales".' },
      { type: 'sub', title: 'Números de emergencia' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  DK: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'País muy seguro. Los conductores daneses son descritos como simpáticos, generosos y abiertos. Jóvenes, mayores, hombres, mujeres: todo el mundo para.' },
      { type: 'sub', title: 'Números de emergencia' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  GB: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'El Reino Unido es globalmente seguro. El miedo mediático supera con creces el riesgo real. La policía es generalmente comprensiva e incluso puede ayudarte a encontrar un mejor spot.' },
      { type: 'sub', title: 'Números de emergencia' },
  ...
  IE: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Irlanda está considerada como uno de los países más seguros del mundo para los viajeros. El autostop es una tradición ancestral y generalmente muy segura.' },
      { type: 'sub', title: 'Números de emergencia' },
      { type: 'kv', items: [
        { k: 'Emergencias', v: '112 o 999' },
        { k: 'Gardaí (policía)', v: '112' },
      ]},
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  HR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Globalmente seguro. La costa está completamente desminada. Las carreteras costeras pueden ser peligrosas (montaña de un lado, acantilado del otro). Precaución como peatón.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  SI: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Muy seguro. Eslovenia es uno de los países más seguros de Europa. Sin minas terrestres. Ninguna preocupación específica para los autostopistas.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  AL: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Globalmente seguro. La criminalidad violenta hacia los turistas es casi inexistente. Los conductores se desvían kilómetros para ayudar. Atención a las condiciones de las carreteras (en mal estado, conducción impredecible) y al escaso tráfico en las montañas del norte.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  RS: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Seguro de día. Los conductores serbios son amigables una vez que paran.' },
      { type: 'warn', text: '⚠️ De noche, se reportan ataques ocasionales en áreas de estacionamiento. Detente en gasolineras 24h o moteles después del anochecer.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  BA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Globalmente seguro para los autostopistas. Descrito como "más seguro que Bélgica" por fuentes holandesas. La hospitalidad es notablemente cálida hacia los extranjeros.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  ME: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'País seguro. A diferencia de sus vecinos, Montenegro evitó los conflictos de los años 90, así que no hay minas terrestres. Las carreteras costeras estrechas y los túneles son el principal riesgo físico para los peatones.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  MK: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Muy seguro. Los locales son no solo acogedores sino a menudo protectores con los visitantes.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  PL: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'País seguro, entre los 25 más seguros del mundo. La policía es amigable con los autostopistas que respetan las reglas.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
      { type: 'warn', text: '⚠️ En el norte de Polonia en verano, hay prostitutas al borde de las carreteras. Las mujeres solas pueden ser confundidas. Consejo: no llevar ropa reveladora, poner la mochila delante.' },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  CZ: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Seguro. La criminalidad se resume a los carteristas en las zonas turísticas. La policía alemana a veces controla los documentos en la frontera checo-alemana.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  SK: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'País seguro. La mejor combinación: viajar en pareja mixta (hombre y mujer).' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  HU: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Seguro y políticamente estable. El agua del grifo es potable en todas partes.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  RO: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Globalmente seguro. Los conductores rumanos son notoriamente agresivos al volante (adelantamientos peligrosos, alta velocidad). Ponte el cinturón. Perros callejeros frecuentes en zona rural.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  BG: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Globalmente seguro pero con advertencias específicas. Conducción agresiva habitual. La policía puede controlar los pasaportes y potencialmente buscar sobornos cerca de las fronteras. Los portadores de pasaportes occidentales rara vez son molestados.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
      { type: 'tip', text: '💡 En Bulgaria, los gestos de cabeza para "sí" y "no" están invertidos respecto a Occidente (asentir = no, negar = sí). Muchos búlgaros se han adaptado a las convenciones occidentales, pero la confusión es frecuente.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  LT: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Sin preocupaciones importantes. El país es muy seguro. Viajar en pareja reduce considerablemente los riesgos.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  LV: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Seguro y tranquilo. El país es muy seguro. Las condiciones de las carreteras se deterioran en invierno e inicio de primavera.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    language: { filterTypes: ['c', 'q'], blocks: [
  ...
  EE: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Muy seguro. Los crímenes relacionados con el autostop son extremadamente raros. Atención a los conductores ebrios: evita los coches donde los ocupantes parezcan borrachos.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  TR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'En el 99% de los casos, el autostop va bien. En Turquía oriental, la policía puede ser desconfiada con los extranjeros (tensiones PKK). Son serios pero ofrecen té y respeto.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
      { type: 'warn', text: '⚠️ Evita las regiones fronterizas con Siria e Irak. El Ministerio de Asuntos Exteriores desaconseja esas zonas.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  GE: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Globalmente seguro. El principal riesgo es la conducción agresiva (alta velocidad, normas de tráfico ignoradas). Las carreteras de montaña pueden ser peligrosas. Rechazar el alcohol (especialmente el chacha, aguardiente nacional) puede ofender en zona rural.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  AM: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Armenia es uno de los países más seguros del mundo. La sensación de seguridad es muy alta. La policía es benevolente y servicial.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
      { type: 'warn', text: '⚠️ Evita las zonas fronterizas con Azerbaiyán (minas, tensiones militares). El tramo Nojemberyan-Idjevan está específicamente desaconsejado.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  BY: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'El país es muy seguro en cuanto a criminalidad. Tasa de delincuencia entre las más bajas de Europa. Sin embargo, el régimen autoritario implica controles policiales frecuentes. Lleva siempre tu pasaporte y tu registro migratorio encima.' },
      { type: 'kv', items: [
        { k: 'Emergencias', v: '112' },
        { k: 'Policía', v: '102' },
        { k: 'Ambulancia', v: '103' },
      ]},
      { type: 'warn', text: '⚠️ No fotografíes edificios gubernamentales ni militares. Evita las discusiones políticas con los conductores.' },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  MD: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Moldavia es un país seguro con baja criminalidad. Evita viajar solo de noche en zonas aisladas. Las estafas de taxi son el principal riesgo (aclara el precio antes).' },
  ...
  UA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'La seguridad depende completamente de la zona. En tiempos de paz, Ucrania es un país seguro con gente acogedora. Consulta los avisos del ministerio de asuntos exteriores antes de viajar.' },
      { type: 'kv', items: [
        { k: 'Emergencias', v: '112' },
        { k: 'Policía', v: '102' },
        { k: 'Ambulancia', v: '103' },
  ...
  XK: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Kosovo es seguro para los viajeros. La criminalidad hacia los turistas es casi inexistente. La presencia internacional (KFOR, EULEX) contribuye a la seguridad.' },
  ...
  MA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Marruecos es generalmente seguro. La criminalidad violenta es rara. Las estafas turísticas (falsos guías, precios inflados) son el principal riesgo. Los marroquíes son mayoritariamente acogedores y protectores con los viajeros.' },
      { type: 'kv', items: [
        { k: 'Policía', v: '19' },
        { k: 'Gendarmería (fuera de la ciudad)', v: '177' },
        { k: 'Bomberos / SAMU', v: '15' },
      ]},
      { type: 'warn', text: '⚠️ Evita las zonas fronterizas con Argelia (cerrada) y las regiones remotas del Sáhara Occidental sin guía local.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  US: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'El riesgo real está sobreestimado por la cultura mediática. El autostop sigue siendo un modo de transporte seguro cuando se respetan las precauciones básicas. Sin embargo, la desconfianza es recíproca: tanto conductores como autostopistas están en guardia.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '911' }] },
      { type: 'warn', text: '⚠️ Nunca aceptes un aventón si el conductor parece bajo la influencia de drogas o alcohol. No hagas autostop de noche. Algunas zonas rurales aisladas no tienen cobertura telefónica.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  NZ: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Nueva Zelanda es uno de los países más seguros del mundo. La criminalidad hacia los turistas es muy rara. Los viajeros solos, incluidas las mujeres, reportan experiencias muy positivas.' },
  ...
  AU: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Australia es generalmente segura pero las distancias y el calor son los verdaderos peligros. En el Outback, las temperaturas superan los 45°C y la cobertura telefónica es inexistente durante cientos de kilómetros.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '000' }, { k: 'Desde móvil', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  IL: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'La seguridad depende de la región. Las zonas centrales (Tel Aviv, Haifa, Galilea) son seguras. Evita Cisjordania sin conocimiento del terreno y las zonas fronterizas con Gaza y Líbano.' },
      { type: 'kv', items: [
        { k: 'Emergencias / Policía', v: '100' },
        { k: 'Ambulancia (Magen David Adom)', v: '101' },
        { k: 'Bomberos', v: '102' },
      ]},
      { type: 'warn', text: '⚠️ La situación de seguridad puede cambiar rápidamente. Consulta las alertas en tiempo real. La app Red Alert avisa de cohetes.' },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  AR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Argentina es generalmente segura para el autostop fuera de Buenos Aires. Patagonia es muy segura. El noroeste es acogedor. Evita los suburbios de Buenos Aires y Rosario.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '911' }, { k: 'Policía', v: '101' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  CL: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Chile es el país más seguro de Sudamérica. La criminalidad violenta es rara fuera de ciertos barrios de Santiago. Los chilenos son acogedores y la Patagonia chilena es muy segura.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '131' }, { k: 'Carabineros (policía)', v: '133' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  CO: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Colombia ha cambiado enormemente desde los años 2000. Las zonas turísticas y las carreteras principales son seguras. Evita las zonas remotas no turísticas y las zonas fronterizas (Venezuela, Ecuador rural).' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '123' }, { k: 'Policía', v: '112' }] },
      { type: 'warn', text: '⚠️ No viajes de noche por las carreteras secundarias. Infórmate localmente sobre las zonas a evitar. Los "falsos positivos" de retenes (falsos controles) son muy raros pero existen.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  TH: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Tailandia es un país seguro para los viajeros. La criminalidad violenta hacia los turistas es muy rara. Las estafas (tuk-tuk, joyerías, taxis sin taxímetro) son el principal riesgo.' },
      { type: 'kv', items: [
        { k: 'Emergencias / Policía turística', v: '1155' },
        { k: 'Ambulancia', v: '1669' },
        { k: 'Policía', v: '191' },
      ]},
    ]},
  ...
  IN: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'India es generalmente segura pero puede ser caótica. Los conductores de camión son generalmente fiables. Nunca subas a un vehículo si los ocupantes parecen ebrios. El tráfico indio es el principal peligro (conducción impredecible).' },
      { type: 'kv', items: [
        { k: 'Emergencias', v: '112' },
        { k: 'Policía', v: '100' },
        { k: 'Ambulancia', v: '108' },
  ...
  JP: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Japón es uno de los países más seguros del mundo. Puedes dejar tu mochila sin vigilancia. La criminalidad hacia los extranjeros es casi inexistente. El único riesgo es perderse.' },
      { type: 'kv', items: [{ k: 'Emergencias / Bomberos', v: '119' }, { k: 'Policía', v: '110' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  ZA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Sudáfrica tiene una tasa de criminalidad elevada. El car-jacking y los robos son riesgos reales. Sin embargo, las zonas rurales y turísticas son mucho más seguras. NUNCA hagas autostop de noche.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '10111' }, { k: 'Ambulancia', v: '10177' }] },
      { type: 'warn', text: '⚠️ No hagas autostop solo(a) en zonas urbanas. Privilegia las zonas rurales y la Garden Route. Infórmate localmente de las zonas a evitar.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  IR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Irán es un país muy seguro para los viajeros. La criminalidad es baja. Los iraníes son protectores con los extranjeros. El principal riesgo es comer demasiado (cada conductor insiste en invitarte). Evita las zonas fronterizas (Sistán-Baluchistán, fronteras con Irak y Afganistán).' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '115' }, { k: 'Policía', v: '110' }] },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  TN: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Túnez es generalmente seguro para los viajeros. Evita las zonas fronterizas con Libia y Argelia (Kasserine, Jendouba). Las estafas turísticas existen en las medinas.' },
      { type: 'kv', items: [{ k: 'Policía', v: '197' }, { k: 'SAMU', v: '190' }, { k: 'Emergencias', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  MX: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'La seguridad varía enormemente según las regiones. El sur (Oaxaca, Chiapas, Yucatán) y el centro (Guanajuato, Puebla) son los más seguros. Evita absolutamente el noroeste (Sinaloa), Tamaulipas y las zonas fronterizas problemáticas.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '911' }, { k: 'Policía turística', v: '078' }] },
      { type: 'warn', text: '⚠️ NUNCA viajes de noche por las carreteras del norte de México. Infórmate localmente y con otros viajeros (grupos de Facebook) sobre las zonas a evitar.' },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  BR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'La seguridad depende de la región. El sur y las zonas rurales son seguros. Evita las favelas y los suburbios de las grandes ciudades (São Paulo, Río). No hagas autostop de noche.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '190 (policía) / 192 (SAMU)' }] },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  PE: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Perú es generalmente seguro fuera de Lima y ciertas zonas fronterizas (VRAEM). Los Andes y el sur turístico (Cusco, Arequipa) son seguros.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '105 (policía) / 116 (bomberos)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  BO: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Bolivia es segura para los viajeros. El principal riesgo es el mal de altura (La Paz está a 3.640m, el Salar a 3.650m). Las carreteras de montaña son peligrosas (curvas, precipicios, sin barandillas).' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '110 (policía) / 118 (ambulancia)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  EC: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Ecuador es moderadamente seguro. Las zonas turísticas (Quito centro, Cuenca, Baños) son seguras. Evita la frontera colombiana (Esmeraldas, Sucumbíos) y los barrios sur de Guayaquil.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '911' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  UY: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Uruguay es el país más seguro de Sudamérica. La tasa de criminalidad es baja fuera de ciertos barrios de Montevideo.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '911' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  VN: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Vietnam es un país muy seguro. La criminalidad violenta es casi inexistente. Los carteristas y las estafas (taxis, tours) son los principales riesgos. El tráfico es caótico pero los accidentes graves con peatones son raros.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '113 (policía) / 115 (ambulancia)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  LA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Laos es un país muy seguro. La criminalidad es muy baja. El principal riesgo son los UXO (bombas sin explotar de la guerra de Vietnam) en zonas rurales. NUNCA te alejes de los caminos trillados en el campo.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '1195 (ambulancia) / 1191 (policía)' }] },
      { type: 'warn', text: '⚠️ Laos es el país más bombardeado de la historia. El 30% de las bombas no explotaron. NUNCA te aventures fuera de los senderos en zona rural.' },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  KH: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Camboya es segura para los viajeros. Evita las zonas fronterizas con Tailandia (Preah Vihear) y las minas antipersona en zonas rurales (no salgas de los senderos).' },
      { type: 'kv', items: [{ k: 'Emergencias / Policía', v: '117' }, { k: 'Ambulancia', v: '119' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  NP: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Nepal es un país seguro y pacífico. La criminalidad hacia los turistas es muy rara. Las carreteras de montaña son el principal peligro (precipicios, carreteras sin asfaltar, conductores audaces).' },
      { type: 'kv', items: [{ k: 'Policía turística', v: '1144' }, { k: 'Emergencias', v: '102 (policía) / 103 (ambulancia)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  KZ: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Kazajistán es seguro. La policía puede hacer controles (lleva tu pasaporte). Las carreteras son largas y rectas, el calor y el viento son los verdaderos enemigos.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }, { k: 'Policía', v: '102' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  KG: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Kirguistán es seguro. La criminalidad es baja. Las carreteras de montaña son el principal peligro (pasos a 3.000m+, sin barandillas).' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }, { k: 'Policía', v: '102' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  UZ: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Uzbekistán es muy seguro. El país es autoritario y la criminalidad es muy baja. Los controles de policía son frecuentes (lleva tu pasaporte y tu registro).' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }, { k: 'Policía', v: '102' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  JO: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Jordania es muy segura. El país es estable y la criminalidad es baja. La policía está presente y es benévola. Evita la frontera siria (noreste).' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '911' }, { k: 'Policía turística', v: '1-800-22-228' }] },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  OM: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Omán es uno de los países más seguros del mundo. La tasa de criminalidad es casi nula. El sultán es venerado y el país es muy ordenado.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '9999' }, { k: 'Policía', v: '9999' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  SN: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Senegal es uno de los países más estables y seguros de África Occidental. La criminalidad hacia los turistas es baja. Evita las zonas fronterizas de Casamance (sur).' },
      { type: 'kv', items: [{ k: 'Policía', v: '17' }, { k: 'Bomberos / SAMU', v: '18' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  NA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Namibia es segura en zona rural. Windhoek tiene barrios a evitar de noche. El principal peligro es la naturaleza: calor, distancias, animales salvajes (elefantes en las carreteras del norte).' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '10111' }, { k: 'Ambulancia', v: '211111' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  KE: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Kenia es generalmente segura fuera de ciertas zonas. Evita el noreste (frontera somalí), los barrios marginales de Nairobi y la costa norte (Lamu) sin información reciente.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '999 / 112' }, { k: 'Policía', v: '999' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  ET: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'La seguridad depende de la región. Las zonas turísticas (Lalibela, Gondar, Valle del Omo) son seguras. Evita las zonas de conflicto (Tigray, ciertas partes de Oromia/Amhara). Verifica la situación actual.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '911 / 991' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  MM: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'La seguridad depende completamente de la situación política actual. Las zonas turísticas clásicas (Bagan, Mandalay, Inle) eran muy seguras antes de 2021. Verifica los avisos del ministerio de asuntos exteriores.' },
  ...
  ID: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Indonesia es generalmente segura. Los indonesios son extremadamente acogedores. Evita la provincia de Papúa (conflictos) y ciertas zonas de Sulawesi.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }, { k: 'Policía', v: '110' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  PH: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Filipinas es generalmente segura para los turistas. Evita el oeste de Mindanao (conflicto armado) y Sulu/Tawi-Tawi (secuestros). Los tifones son un riesgo real de junio a noviembre.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '911' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  LK: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Sri Lanka es un país seguro. La guerra civil terminó en 2009. La criminalidad hacia los turistas es muy rara. Los cingaleses son protectores con los visitantes.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '119 (policía) / 110 (ambulancia)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  MN: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Mongolia es segura en zona rural. Ulán Bator tiene problemas de alcoholismo y carteristas. La naturaleza es el verdadero peligro: frío extremo, distancias, ausencia de cobertura.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '102 (policía) / 103 (ambulancia)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  CU: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Cuba es uno de los países más seguros de las Américas. La criminalidad violenta es casi inexistente. Las estafas menores (jineteros) son el principal riesgo turístico.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '106 (policía) / 104 (ambulancia)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  GT: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Guatemala tiene una alta tasa de criminalidad en las ciudades (Ciudad de Guatemala, zonas de narcotráfico). Los Highlands y las zonas turísticas (Antigua, Atitlán) son mucho más seguros. No viajes de noche.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '110 (bomberos) / 120 (policía)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  CR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Costa Rica es el país más seguro de Centroamérica. La criminalidad turística es baja. Los pequeños robos son el principal riesgo (sobre todo en las playas).' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '911' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  EG: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Egipto es generalmente seguro para los turistas en las zonas principales (El Cairo, Lúxor, Asuán, costa). Evita el norte del Sinaí (excepto Sharm el-Sheikh y Dahab) y la frontera libia.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '122 (policía) / 123 (ambulancia)' }] },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  TZ: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Tanzania es segura para los viajeros. La criminalidad turística es baja. Evita Dar es Salaam de noche y ciertos barrios.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112 / 114' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  TJ: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Tayikistán es seguro. La criminalidad es baja. Las carreteras del Pamir son peligrosas (precipicios, sin barandillas, altitud). La altitud puede causar mal agudo de montaña.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  KR: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Corea del Sur es uno de los países más seguros del mundo. La criminalidad es casi inexistente. Puedes dejar tus cosas en cualquier parte.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112 (policía) / 119 (bomberos/ambulancia)' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  PK: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'El norte (Hunza, Gilgit-Baltistán, Swat) es muy seguro. Evita Baluchistán, el sur del KPK y las zonas tribales.' },
      { type: 'kv', items: [{ k: 'Rescue', v: '1122' }, { k: 'Policía', v: '15' }] },
    ]},
    women: { filterTypes: ['q', 'c', 'a'], blocks: [
  ...
  MY: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'País seguro. Evita el este de Sabah (secuestros). Las estafas de taxi son el principal riesgo.' },
  ...
  TW: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Uno de los países más seguros de Asia. Criminalidad casi inexistente.' },
      { type: 'kv', items: [{ k: 'Policía', v: '110' }, { k: 'Emergencias', v: '119' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  LB: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'La seguridad fluctúa. Zonas turísticas (Beirut, Biblos, Baalbek) generalmente seguras. Verifica la situación actual.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }, { k: 'Cruz Roja', v: '140' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  PA: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Relativamente seguro. Evita Colón y el Darién.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '911' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  GH: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Uno de los países más estables de África. Criminalidad turística baja.' },
      { type: 'kv', items: [{ k: 'Policía', v: '191' }, { k: 'Ambulancia', v: '193' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  UG: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Globalmente seguro. Evita la frontera congoleña y el Karamoja. Los gorilas de Bwindi están en una zona segura.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '999 / 112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  RW: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Uno de los países más seguros de África. Criminalidad muy baja, limpio y organizado.' },
      { type: 'kv', items: [{ k: 'Emergencias', v: '112' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
  ...
  MW: {
    ...
    safety: { filterTypes: ['c', 'a'], blocks: [
      { type: 'text', text: 'Muy seguro. Criminalidad turística muy rara.' },
      { type: 'kv', items: [{ k: 'Policía', v: '997' }, { k: 'Ambulancia', v: '998' }] },
    ]},
    women: { filterTypes: ['q', 'c'], blocks: [
