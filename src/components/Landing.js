...
export function renderLanding() {
  ...
  return `
    <div id="landing-page" class="fixed inset-0 z-[100] bg-dark-primary overflow-hidden">
      ...
      <!-- Carousel Track -->
      <div id="landing-track" class="flex h-full transition-transform duration-300 ease-out" style="width:800%">

        <!-- Slide 1: Bienvenue -->
        <div class="w-[12.5%] h-full flex-shrink-0 flex flex-col items-center justify-center px-6 text-center relative" style="background:#192839">
        ...
        <div class="w-[12.5%] h-full flex-shrink-0 flex flex-col items-center justify-center px-6 text-center relative" style="background:linear-gradient(180deg,#101722,#0f1520)">
        ...
        <!-- Slide 3: Ton rôle -->
        <div class="w-[12.5%] h-full flex-shrink-0 flex flex-col items-center justify-center px-6 text-center relative" style="background:linear-gradient(180deg,#121a28,#0f1520)">
        ...
        <!-- Slide 4: Roadmap -->
        <div class="w-[12.5%] h-full flex-shrink-0 flex flex-col items-center justify-center px-6 text-center relative" style="background:linear-gradient(180deg,#111825,#0f1520)">
        ...
        <div class="w-[12.5%] h-full flex-shrink-0 flex flex-col items-center justify-center px-6 text-center relative" style="background:linear-gradient(180deg,#0f1722,#0f1520)">
        ...
        <div class="w-[12.5%] h-full flex-shrink-0 flex flex-col items-center justify-center px-6 text-center relative" style="background:linear-gradient(180deg,#131b2a,#0f1520)">
        ...
        <!-- Slide 8: Connexion obligatoire -->
        <div class="w-[12.5%] h-full flex-shrink-0 flex flex-col items-center justify-center px-6 text-center relative" style="background:linear-gradient(180deg,#161e2e,#0f1520)">
          ...
          <div class="flex items-center mb-7 relative z-10">${stepIndicator(7)}</div>
          <span class="text-5xl mb-4 relative z-10">🔐</span>
          <h2 class="text-[26px] font-extrabold text-white leading-tight mb-3 tracking-tight relative z-10">
            ${t('landingAuthTitle')}
          </h2>
      ...
      <div class="absolute bottom-0 left-0 right-0 flex items-center justify-between px-7 pb-10 pt-4 z-10" style="background:linear-gradient(transparent,#0f1520)">
        <div id="landing-dots" class="flex gap-2">
          ...
          <div class="landing-dot w-2 h-2 rounded-full bg-white/20 transition-colors duration-200" data-i="7"></div>
        </div>
...
const SLIDE_WIDTH = 100 / TOTAL_SLIDES // 12.5%
