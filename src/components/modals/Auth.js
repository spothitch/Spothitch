      ...
      >
        ...
        <div class="px-6 space-y-3">
          ...
          <div class="relative" id="auth-google-wrapper">
            ...
            <!-- GIS overlay: starts with pointer-events:none so clicks fall through to button.
                 setupGISOverlay enables pointer-events:auto ONLY after GIS iframe is rendered. -->
            <div id="gis-overlay" style="position:absolute;top:0;left:0;width:100%;height:100%;overflow:hidden;border-radius:12px;pointer-events:none"></div>
          </div>
