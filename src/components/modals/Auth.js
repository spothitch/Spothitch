      ...
      <div
        ...
        <div class="px-6 space-y-3">
          ...
          <div class="relative" id="auth-google-wrapper">
            ...
            <!-- GIS overlay: always opacity-0.01 so Google's own (wrong-language) button
                 stays invisible and OUR styled button shows through. Opacity does not block
                 clicks. Starts pointer-events-none so clicks fall through to our button until
                 setupGISOverlay confirms GIS is ready, then enables pointer-events. -->
            <div id="gis-overlay" class="absolute inset-0 w-full h-full overflow-hidden rounded-xl pointer-events-none opacity-[0.01]"></div>
          </div>
        </div>
