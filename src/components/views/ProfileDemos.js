...
const _previewBanner = `<div class="bg-amber-500/20 border border-amber-500/30 rounded-xl px-3 py-2 mb-3 text-center"><span class="text-amber-400 text-xs font-semibold">${t('demoPreviewBanner') || 'Aperçu. Les noms et chiffres sont fictifs.'}</span></div>`
...
window.showPointsDemo = () => {
 ...
 <div class="${_c.bullet}"><span class="${_c.bicon}"></span><span class="${_c.btxt}">6 niveaux : Débutant → Explorateur → Aventurier → Voyageur → Expert → Légende</span></div></div>
 <button onclick="startPointsDemo()" class="${_c.btn}" style="${_btnStyle}">${escapeHTML(t('cityDemoIntroBtn') || 'Découvrir la démo')}</button></div>
 <div id="points-demo-main" class="hidden"></div></div>
 `
...
window.startPointsDemo = () => {
 ...
 <span class="cd-tab" onclick="switchDemoTab(this,'pts-partners')" role="button" tabindex="0">Réductions</span></div>
 ...
 <span class="px-2.5 py-1 rounded-[10px] text-[0.58rem] font-semibold bg-transparent text-slate-400 border border-white/[0.08]"> Amis</span></div></div>
 ...
 <div class="text-center mt-2 text-[0.68rem]"><span class="font-bold">Tes points : <span class="text-amber-400">1 250</span></span><br><span class="text-[0.6rem] text-slate-500">Tu peux déjà débloquer Flixbus (-10%) et Airalo (-15%) !</span></div></div></div>
 `
}
...
window.showJournalDemo = () => {
 ...
 <div class="${_c.bullet}"><span class="${_c.bicon}"></span><span class="${_c.btxt}">Visualise ton parcours étape par étape sur une carte avec la timeline de chaque jour</span></div>
 ...
 <div class="${_c.bullet}"><span class="${_c.bicon}"></span><span class="${_c.btxt}">Explore les voyages des autres autostoppeurs pour trouver l'inspiration et planifier tes prochaines aventures</span></div></div>
 <button onclick="startJournalDemo()" class="${_c.btn}" style="${_btnStyle}">${escapeHTML(t('cityDemoIntroBtn') || 'Découvrir la démo')}</button></div>
 <div id="journal-demo-main" class="hidden"></div></div>
 `
 document.body.appendChild(ov)
}
...
window.startJournalDemo = () => {
 ...
 <div class="absolute text-[0.5rem] text-slate-500 bottom-[5px] right-[8px]">🇫🇷 → 🇪🇸</div></div>
 ...
 <div class="${_c.stat}"><div class="text-[0.85rem] font-extrabold text-amber-400">2</div><div class="text-[0.45rem] text-slate-500 uppercase">pays</div></div></div>

 <div class="${_c.tabs}">
 <span class="cd-tab cd-tab-active" onclick="switchDemoTab(this,'jrn-current')" role="button" tabindex="0">Voyage en cours</span>
 <span class="cd-tab" onclick="switchDemoTab(this,'jrn-history')" role="button" tabindex="0"> Mes voyages</span>
 <span class="cd-tab" onclick="switchDemoTab(this,'jrn-community')" role="button" tabindex="0">Communauté</span></div>
 ...
 <div class="flex gap-1"><div class="flex-1 text-center"><div class="text-[0.8rem] font-extrabold text-amber-400">1 085</div><div class="text-[0.45rem] text-slate-500 uppercase">km</div></div><div class="flex-1 text-center"><div class="text-[0.8rem] font-extrabold text-amber-400">4</div><div class="text-[0.45rem] text-slate-500 uppercase">lifts</div></div><div class="flex-1 text-center"><div class="text-[0.8rem] font-extrabold text-amber-400">8h30</div><div class="text-[0.45rem] text-slate-500 uppercase">temps</div></div></div></div>
 <div class="${_c.card} border border-white/[0.04] p-3">
 ...
 <div class="flex gap-1"><div class="flex-1 text-center"><div class="text-[0.8rem] font-extrabold text-amber-400">1 050</div><div class="text-[0.45rem] text-slate-500 uppercase">km</div></div><div class="flex-1 text-center"><div class="text-[0.8rem] font-extrabold text-amber-400">6</div><div class="text-[0.45rem] text-slate-500 uppercase">lifts</div></div><div class="flex-1 text-center"><div class="text-[0.8rem] font-extrabold text-amber-400">14h</div><div class="text-[0.45rem] text-slate-500 uppercase">temps</div></div></div></div>
 <div class="${_c.card} border border-white/[0.04] p-3">
...
window.showSocialDemo = () => {
 ...
 <div class="${_c.bullet}"><span class="${_c.bicon}"></span><span class="${_c.btxt}">Discute avec les autostoppeurs proches et trouve des compagnons de route pour tes trajets</span></div></div>
 <button onclick="startSocialDemo()" class="${_c.btn}" style="${_btnStyle}">${escapeHTML(t('cityDemoIntroBtn') || 'Découvrir la démo')}</button></div>
 <div id="social-demo-main" class="hidden"></div></div>
 `
 document.body.appendChild(ov)
}
...
window.startSocialDemo = () => {
 ...
 <span class="cd-tab" onclick="switchDemoTab(this,'soc-spots')" role="button" tabindex="0">Spots partagés</span></div>
 ...
 <div class="absolute text-[0.5rem] text-slate-400 bottom-[5px] left-[6px]">3 autostoppeurs dans un rayon de 5 km</div></div>
 ...
 <div class="${_c.card}"><div class="flex justify-between"><div><div class="font-bold">Sortie Nîmes</div><div class="text-[0.58rem] text-slate-400">A9 direction Espagne · Alex il y a 30min</div></div><span class="text-[0.62rem] font-bold text-emerald-500">⏱️ 5 min</span></div><div class="text-[0.6rem] text-slate-400 mt-[3px] italic">"Spot incroyable, 5 min !" · Alex</div></div></div></div>
 `
}
...
window.startCompanionDemo = () => {
 ...
 <span class="cd-tab" onclick="switchDemoTab(this,'cmp-guardian')" role="button" tabindex="0">Vue Gardien</span>
 <span class="cd-tab" onclick="switchDemoTab(this,'cmp-config')" role="button" tabindex="0"> Réglages</span></div>
 ...
 <div class="absolute text-[0.5rem] text-emerald-500 font-bold rounded top-[5px] right-[6px] bg-black/60 px-1.5 py-0.5">Mis à jour il y a 30s</div></div>
 ...
 <div class="${_c.stat}"><div class="text-[0.85rem]"></div><div class="text-[0.45rem] text-slate-500">Arrivée</div><div class="text-[0.65rem] font-bold">Barcelone</div></div></div>
 ...
 <div class="${_c.card} mt-2 border border-red-500/20 bg-red-500/5"><div class="text-[0.68rem] font-bold text-red-500 mb-[3px]"> Si un check-in est manqué</div><div class="text-[0.58rem] text-slate-400">Alerte immédiate + dernière position + appeler directement + contacter urgences</div></div></div>
 ...
 <div class="${_c.card} text-center"><div class="text-[0.85rem]"></div><div class="text-[0.65rem] font-semibold">2 heures</div><div class="text-[0.5rem] text-slate-500">Relax</div></div></div>
 ...
 <div class="flex justify-between"><span class="text-[0.68rem]">⏳ Délai avant alerte</span><span class="text-amber-400 text-[0.6rem] font-bold">15 min</span></div></div>
 <div class="${_c.secT} mt-2"><span class="text-[0.85rem]">🆘</span> Bouton SOS</div>
 <div class="${_c.card} border border-red-500/20"><div class="text-[0.68rem] font-semibold mb-[3px]">Le SOS déclenche simultanément :</div><div class="text-[0.6rem] text-slate-400">Alerte tous tes gardiens<br> SMS + appel au gardien principal<br>Position aux urgences (112)<br> Alarme sonore<br> Enregistrement audio</div></div></div></div>
 `
}
...
window.showHostelsDemo = () => {
 ...
 <div class="${_c.bullet}"><span class="${_c.bicon}"></span><span class="${_c.btxt}">Filtres par ambiance : Festif, Calme, Budget, Social, Éco. Trouve l'auberge qui te correspond</span></div>
 ...
 <div class="${_c.bullet}"><span class="${_c.bicon}"></span><span class="${_c.btxt}">Découvre les événements autour de toi et inscris-toi en un clic</span></div></div>
 <button onclick="startHostelsDemo()" class="${_c.btn}" style="${_btnStyle}">${escapeHTML(t('cityDemoIntroBtn') || 'Découvrir la démo')}</button></div>
 <div id="hostels-demo-main" class="hidden"></div></div>
 `
 document.body.appendChild(ov)
}
...
window.startHostelsDemo = () => {
 ...
 <span class="cd-tab" onclick="switchDemoTab(this,'htl-create')" role="button" tabindex="0"> Créer un event</span></div>
 ...
 <span class="px-2.5 py-1 rounded-[10px] text-[0.58rem] font-semibold bg-dark-secondary text-slate-400">🇳🇱 Amsterdam</span></div>
 ...
 <span class="py-[3px] px-2 rounded-[10px] text-[0.52rem] font-semibold bg-dark-secondary text-slate-400">Budget</span></div>
 ...
 <div class="${_c.card} p-2.5"><div class="flex gap-2 items-start mb-1"><span class="text-[1.2rem]"></span><div><div class="font-bold text-[0.78rem]">Rassemblement Européen · Bruxelles</div><div class="text-[0.58rem] text-amber-400 font-semibold">1-3 mai 2026</div></div></div><div class="text-[0.62rem] text-slate-400 mb-1">200+ participants, 15 pays, conférences, courses.</div><div class="flex justify-between items-center"><div class="text-[0.55rem] text-slate-500">142 · 15 pays</div><span class="text-[0.6rem] font-bold px-2.5 py-1 rounded-md bg-amber-400/15 text-amber-400">J'y vais !</span></div></div></div>
...
window.showSpotDemo = () => {
 ...
 <div class="${_c.bullet}"><span class="${_c.bicon}"></span><span class="${_c.btxt}">${escapeHTML(t('spotDemoBullet5') || 'Ouvre directement dans Google Maps pour y aller à pied. Un seul bouton')}</span></div></div>
 <button onclick="startSpotDemo()" class="${_c.btn}" style="${_btnStyle}">${escapeHTML(t('cityDemoIntroBtn') || 'Découvrir la démo')}</button></div>
 <div id="spot-demo-main" class="hidden"></div></div>
 `
 document.body.appendChild(ov)
}
...
window.startSpotDemo = () => {
 ...
 <span class="cd-tab" onclick="switchSpotDemoTab(this,'spot-emergency')" role="button" tabindex="0">🆘 Urgence</span></div>
 ...
 <div class="text-[0.55rem] text-white/50"> Sortie de ville · E411 · 🇧🇪</div></div>
 <div class="${_spot.score} absolute bottom-1.5 right-[50px]" style="${_spotStyles.score}">4.2</div></div></div>
 ...
 <button class="${_spot.btnT}" style="${_spotStyles.btnT}"><span class="text-[1.1rem]"></span>J'ai testé<span class="text-[0.5rem] font-normal opacity-50">Donner mon avis</span></button></div>
 ...
 <div class="text-[0.5rem] text-[#475569]">par @TravelMarc</div></div>
 ...
 <div class="text-[0.5rem] text-[#475569]">@BenTheRoad · ★★★★★</div></div></div>
 ...
 <span class="${_spot.badge}" style="${_spotStyles.bg}"> Légal</span>
 <span class="${_spot.badge}" style="${_spotStyles.ba}"> Printemps</span></div>
 ...
 <div class="${_spot.metric}" style="${_spotStyles.metric}"><div class="text-[0.55rem] text-[#475569]"></div><div class="text-[0.7rem] font-extrabold text-emerald-600">4/5</div></div>
 ...
 <div class="${_spot.metric}" style="${_spotStyles.metric}"><div class="text-[0.55rem] text-[#475569]"></div><div class="text-[0.7rem] font-extrabold text-blue-500">12</div></div></div>

 <!-- Tags -->
 <div class="flex flex-wrap gap-1 mb-2">
 <span class="${_spot.badge}" style="${_spotStyles.bg}"> Abri</span>
 <span class="${_spot.badge}" style="${_spotStyles.bg}">Visible</span>
 <span class="${_spot.badge}" style="${_spotStyles.bg}">🅿️ Place</span>
 <span class="${_spot.badge}" style="${_spotStyles.bb}">Éclairé</span>
 <span class="${_spot.badge}" style="${_spotStyles.ba}"> Pouce</span></div>

 <!-- Actions secondaires -->
 <div class="flex gap-1">
 <div class="${_spot.secBtn}"> Sauver</div>
 <div class="${_spot.secBtn}"> Partager</div>
 <div class="${_spot.secBtn}"> Signaler</div></div></div>

 <!-- ===== TAB 2: DÉTAILS ===== -->
 <div data-cd-panel="spot-details" class="hidden">
 <div class="${_c.secT}">Notation détaillée</div>
 <div class="${_c.card}">
 <div class="flex justify-between mb-1"><span class="text-[0.65rem]">Sécurité</span><span class="text-[0.65rem] font-bold text-[#6ee7b7]">4/5</span></div>
 ...
 <div class="h-[5px] bg-slate-800 rounded-[3px] overflow-hidden"><div class="h-full bg-amber-500 rounded-[3px] w-[60%]"></div></div></div>
 ...
 <div class="text-[0.58rem] text-slate-500 mt-0.5">4 min d'attente vs 15 min le dimanche soir</div></div>
 ...
 <div class="text-[0.65rem]"><strong class="text-amber-400">@TravelMarc :</strong> Se placer APRÈS le feu rouge. Les voitures tournent toutes vers l'E411.</div></div>
 <div class="${_c.card} bg-amber-500/5 border border-amber-500/15">
 <div class="text-[0.65rem]"><strong class="text-amber-400">@BenTheRoad :</strong> Écrire "LIÈGE" sur la pancarte, pas "E411".</div></div>
 ...
 <div class="text-[0.62rem] text-slate-400">Super spot ! Pris en 5 min un lundi matin. Je recommande.</div></div>
 <div class="${_c.card}">
 ...
 <div class="text-[0.62rem] text-slate-400">Bon spot, un peu long à deux mais ça passe.</div></div>
 ...
 <span class="${_spot.badge} text-[0.45rem]" style="${_spotStyles.bg}">Mieux!</span></div></div>
 ...
 <div><div class="font-bold text-[0.72rem]">CHU Namur</div><div class="text-[0.55rem] text-slate-500">2.8 km · +32 81 72 61 11</div></div></div>
 <div class="${_c.card} flex items-center gap-2 mb-[5px]">
 <span class="text-[1.1rem]"></span>
 <div><div class="font-bold text-[0.72rem]">Police locale</div><div class="text-[0.55rem] text-slate-500">1.5 km · +32 81 24 81 11</div></div></div>
 <div class="${_c.card} flex items-center gap-2">
 <span class="text-[1.1rem]"></span>
 <div><div class="font-bold text-[0.72rem]">Bus 38 → Liège</div><div class="text-[0.55rem] text-slate-500">400m · ~7€ · Toutes les 30 min</div></div></div>

 <div class="${_c.secT} mt-2.5"> Auto-stop en Belgique</div>
 ...
 <div class="text-[0.62rem] text-slate-400">L'auto-stop est légal en Belgique. Interdit sur les autoroutes (accotements), mais autorisé aux entrées et aires de repos.</div></div>
 ...
 <div class="text-[0.58rem] text-slate-500 mt-0.5">Envoie ta position + alerte à tes contacts</div></div></div></div>
 `
}
