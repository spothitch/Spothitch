...
window.showCityPageDemo = () => {
  ...
  overlay.innerHTML = `
    <div id="city-demo-overlay-content" class="w-full max-w-[420px] m-4 relative">
      <div class="bg-amber-500/20 border border-amber-500/30 rounded-xl px-3 py-2 mb-3 text-center"><span class="text-amber-400 text-xs font-semibold">👁️ ${t('demoPreviewBanner') || 'Aperçu. Les noms et chiffres sont fictifs.'}</span></div>
      <!-- Close button -->
