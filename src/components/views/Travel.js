    ...
    <div class="card p-4 space-y-4 border-primary-500/30">
      ...
      ${spots.length > 0 ? `
        <div class="flex flex-wrap gap-1.5 px-1">
          ...
          <button onclick="setRouteFilter('rating4')" class="px-2.5 py-1 rounded-full text-xs font-medium transition-colors ${state.routeFilter === 'rating4' ? 'bg-primary-500 text-white' : 'bg-white/5 text-slate-400 hover:bg-white/10'}">${icon('star', 'w-3 h-3 inline mr-0.5')} 4+</button>
          <button onclick="setRouteFilter('wait20')" class="px-2.5 py-1 rounded-full text-xs font-medium transition-colors ${state.routeFilter === 'wait20' ? 'bg-primary-500 text-white' : 'bg-white/5 text-slate-400 hover:bg-white/10'}">${icon('clock', 'w-3 h-3 inline mr-0.5')} &lt;20min</button>
