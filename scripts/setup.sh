...
echo "  npm run test:mutate     StrykerJS (qualité des tests, LOCAL uniquement)"
echo ""
echo "OUTILS DE VERIFICATION (auto, sur GitHub) :"
echo "  CodeRabbit    — IA qui relit le code (GitHub App)"
echo "  DeepSource    — 5000+ règles qualité (GitHub App)"
echo "  Aikido        — Sécurité npm (GitHub App)"
echo "  Lighthouse CI — Performance (GitHub Actions)"
echo "  Argos CI      — Comparaison visuelle (GitHub App)"
echo "  StrykerJS     — Test des tests (LOCAL : npm run test:mutate)"
echo ""
echo "  Les 5 apps GitHub sont liées au repo, pas au local."
echo "  Elles continuent de fonctionner après un crash Linux."
echo "  StrykerJS et Argos sont dans les devDependencies (npm install les restaure)."
echo "============================================"
